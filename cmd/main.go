...
import (
	...
	"github.com/tommymcarver/clusterscan-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cdf85d67.spectrocloud.com",
	...
	// Create kubernetes clientset for reading pod logs
